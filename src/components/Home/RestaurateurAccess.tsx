  ...
  return (
    <div className="bg-accent/10 p-4 rounded-lg border border-accent/20 shadow-md">
      <div className="flex items-center justify-between mb-2">
        <h3 className="font-semibold flex items-center text-primary drop-shadow-[0_1px_1px_rgba(0,0,0,0.3)]">
          <Store className="mr-2 h-5 w-5 drop-shadow-[0_1px_1px_rgba(0,0,0,0.4)]" strokeWidth={2.5} />
          Accesso Ristoratori
        </h3>
