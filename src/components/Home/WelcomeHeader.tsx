  ...
  return (
    <div className={`space-y-2 ${className}`}>
      <div className="flex items-center gap-2">
        <div className="flex items-center justify-center p-2 rounded-full bg-gradient-to-br from-accent to-secondary shadow-sm">
          <div className="relative">
            <Wheat size={20} className="text-white" />
            <Utensils size={14} className="text-white absolute -bottom-1 -right-1" />
          </div>
        </div>
        <h1 className="text-3xl font-poppins font-bold bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent">
          Gluten Free Eats
        </h1>
      </div>
